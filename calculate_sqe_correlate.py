...
################################################################################
## The input files for this script are infile.positions and infile.ssposcar ####
################################################################################
...
reciprocal_mat = np.array(([2*np.pi/unit_lc,0,0],[0,2*np.pi/unit_lc,0],[0,0,2*np.pi/unit_lc]))
'''
k_raw = (2,0.5,0)
...
print ('Finish phase calculation')
...
np.savetxt('freq_test.txt',freq)
np.savetxt('sqe_test.txt',sqe)
'''
